      ...
      <div>
         <div class='ekit-review-overview-trustpilot--thumbnails d-flex justify-content-end'>
            <div class='ekit-review-overview-trustpilot--thumbnail'>
               <img src="<?php echo esc_url( $BASE_URL . 'assets/images/thumbnail1.png' ); ?>" alt="Thumbnail">
            </div>
            <div class='ekit-review-overview-trustpilot--thumbnail'>
               <img src="<?php echo esc_url( $BASE_URL . 'assets/images/thumbnail2.png' ); ?>" alt="Thumbnail">
            </div>
            <div class='ekit-review-overview-trustpilot--thumbnail'>
               <img src="<?php echo esc_url( $BASE_URL . 'assets/images/thumbnail13.png' ); ?>" alt="Thumbnail">
            </div>
            <div class='ekit-review-overview-trustpilot--thumbnail'>
               <img src="<?php echo esc_url( $BASE_URL . 'assets/images/thumbnail14.png' ); ?>" alt="Thumbnail">
            </div>
         </div>
